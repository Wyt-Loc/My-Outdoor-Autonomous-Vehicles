...
/* 宏定义 --------------------------------------------------------------------*/
#define STEPMOTOR_TIMx                        TIM1                //定时器输出脉冲
...
#define STEPMOTOR_TIMx_IRQn                   TIM1_CC_IRQn			  //定时器捕获比较中断
#define STEPMOTOR_TIMx_IRQHandler             TIM1_CC_IRQHandler	//中断服务函数
...
#define STEPMOTOR_TIM_PULSE_PIN_X             GPIO_PIN_8          //输出脉冲给X轴电机控制器

#define ORIGIN_X_DETECT_GPIO_CLK_ENABLE()     __HAL_RCC_GPIOC_CLK_ENABLE()	//X轴原点检测引脚
#define ORIGIN_X_DETECT_PORT					        GPIOC			          					
#define ORIGIN_X_DETECT_PIN					          GPIO_PIN_2
#define ORIGIN_X_EXTI_IRQn            	      EXTI2_IRQn                     
#define ORIGIN_X_DOG_MSG						          0								              //检测到近点信号时引脚电平

#define LIMPOS_X_GPIO_CLK_ENABLE()      		  __HAL_RCC_GPIOC_CLK_ENABLE()  // 正转极限位输入引脚
#define LIMPOS_X_PORT                   		  GPIOC
#define LIMPOS_X_PIN                    		  GPIO_PIN_10
#define LIMPOS_X_EXTI_IRQn						        EXTI15_10_IRQn
#define LIMPOS_X_LEVEL						            0	                            //正转极限引脚有效电平

#define LIMNEG_X_GPIO_CLK_ENABLE()      		  __HAL_RCC_GPIOF_CLK_ENABLE()  // 反转限位输入引脚
#define LIMNEG_X_PORT                   		  GPIOF       
#define LIMNEG_X_PIN                    		  GPIO_PIN_6  
#define LIMNEG_X_EXTI_IRQn						        EXTI9_5_IRQn
#define LIMNEG_X_LEVEL						            0	                            //反转极限引脚有效电平

#define STEPMOTOR_X_DIR_GPIO_CLK_ENABLE()     __HAL_RCC_GPIOB_CLK_ENABLE()  // 电机旋转方向控制，如果悬空不接默认正转
#define STEPMOTOR_X_DIR_PORT                  GPIOB                         // 对应STEPMOTOR的DIR-（控制器使用共阳接法）
#define STEPMOTOR_X_DIR_PIN                   GPIO_PIN_12                    // 而DIR+直接接开发板的+5V(或3.3V)

#define STEPMOTOR_X_ENA_GPIO_CLK_ENABLE()     __HAL_RCC_GPIOB_CLK_ENABLE()  // 电机使能控制，如果悬空不接默认使能电机
#define STEPMOTOR_X_ENA_PORT                  GPIOB                         // 对应STEPMOTOR的ENA-（控制器使用共阳接法）
#define STEPMOTOR_X_ENA_PIN                   GPIO_PIN_0                    // 而ENA+直接开发板的+5V(或3.3V) 
...
#define STEPMOTOR_TIM_PULSE_PIN_Y             GPIO_PIN_9                    // 输出脉冲给Y轴电机控制器

#define ORIGIN_Y_DETECT_GPIO_CLK_ENABLE()     __HAL_RCC_GPIOC_CLK_ENABLE()	
...
#define LIMPOS_Y_GPIO_CLK_ENABLE()      		  __HAL_RCC_GPIOC_CLK_ENABLE()  // 正转极限位输入引脚
#define LIMPOS_Y_PORT                   		  GPIOC       
#define LIMPOS_Y_PIN                    		  GPIO_PIN_11
#define LIMPOS_Y_EXTI_IRQn						        EXTI15_10_IRQn
#define LIMPOS_Y_LEVEL						            0	                            //正转极限引脚有效电平

#define LIMNEG_Y_GPIO_CLK_ENABLE()      		  __HAL_RCC_GPIOF_CLK_ENABLE()  // 反转限位输入引脚
#define LIMNEG_Y_PORT                   		  GPIOF       
#define LIMNEG_Y_PIN                    		  GPIO_PIN_7  
...
#define STEPMOTOR_Y_DIR_PIN                   GPIO_PIN_13                      // 而DIR-直接接开发板的GND
...
#define STEPMOTOR_Y_ENA_PIN                   GPIO_PIN_1                       // 而ENA-直接开发板的GND 
...
#define STEPMOTOR_TIM_PULSE_PIN_Z             GPIO_PIN_10                   //输出脉冲给Z轴电机控制器

#define ORIGIN_Z_DETECT_GPIO_CLK_ENABLE()     __HAL_RCC_GPIOC_CLK_ENABLE()	
#define ORIGIN_Z_DETECT_PORT					        GPIOC								
#define ORIGIN_Z_DETECT_PIN					          GPIO_PIN_4										//z轴原点检测引脚
#define ORIGIN_Z_EXTI_IRQn            	      EXTI4_IRQn
#define ORIGIN_Z_DOG_MSG						          0

#define LIMPOS_Z_GPIO_CLK_ENABLE()      		  __HAL_RCC_GPIOC_CLK_ENABLE()  // 正转极限位输入引脚
#define LIMPOS_Z_PORT                   		  GPIOC       
#define LIMPOS_Z_PIN                    		  GPIO_PIN_12    
#define LIMPOS_Z_EXTI_IRQn						        EXTI15_10_IRQn
#define LIMPOS_Z_LEVEL						            0	                            //正转极限引脚有效电平

#define LIMNEG_Z_GPIO_CLK_ENABLE()      		  __HAL_RCC_GPIOF_CLK_ENABLE()  // 反转限位输入引脚
#define LIMNEG_Z_PORT                   		  GPIOF       
#define LIMNEG_Z_PIN                    		  GPIO_PIN_8  
#define LIMNEG_Z_EXTI_IRQn						        EXTI9_5_IRQn
#define LIMNEG_Z_LEVEL						            0	                            //反方向极限引脚有效电平

#define STEPMOTOR_Z_DIR_GPIO_CLK_ENABLE()     __HAL_RCC_GPIOB_CLK_ENABLE()     // 电机旋转方向控制，如果悬空不接默认正转
#define STEPMOTOR_Z_DIR_PORT                  GPIOB                            // 对应STEPMOTOR的DIR+（控制器使用共阴接法）
#define STEPMOTOR_Z_DIR_PIN                   GPIO_PIN_14                      // 而DIR-直接接开发板的GND

#define STEPMOTOR_Z_ENA_GPIO_CLK_ENABLE()     __HAL_RCC_GPIOC_CLK_ENABLE()     // 电机使能控制，如果悬空不接默认使能电机
#define STEPMOTOR_Z_ENA_PORT                  GPIOC                            // 对应STEPMOTOR的ENA+（控制器使用共阴接法）
#define STEPMOTOR_Z_ENA_PIN                   GPIO_PIN_6                      // 而ENA-直接开发板的GND 
...
#define STEPMOTOR_TIM_PULSE_PIN_R             GPIO_PIN_11                   //输出脉冲给R轴电机控制器

#define ORIGIN_R_DETECT_GPIO_CLK_ENABLE()     __HAL_RCC_GPIOC_CLK_ENABLE()	
#define ORIGIN_R_DETECT_PORT					        GPIOC								
#define ORIGIN_R_DETECT_PIN					          GPIO_PIN_5
#define ORIGIN_R_EXTI_IRQn            	      EXTI9_5_IRQn
#define ORIGIN_R_DOG_MSG						          0

#define LIMPOS_R_GPIO_CLK_ENABLE()      		  __HAL_RCC_GPIOC_CLK_ENABLE()  // 正转极限位输入引脚
#define LIMPOS_R_PORT                   		  GPIOC       
#define LIMPOS_R_PIN                    		  GPIO_PIN_13    
#define LIMPOS_R_EXTI_IRQn						        EXTI15_10_IRQn
#define LIMPOS_R_LEVEL						            0	                            //反转极限引脚有效电平

#define LIMNEG_R_GPIO_CLK_ENABLE()      		  __HAL_RCC_GPIOF_CLK_ENABLE()  // 反转限位输入引脚
#define LIMNEG_R_PORT                   		  GPIOC       
#define LIMNEG_R_PIN                    		  GPIO_PIN_9 
#define LIMNEG_R_EXTI_IRQn						        EXTI9_5_IRQn
#define LIMNEG_R_LEVEL						            0	                            //反方向极限引脚有效电平

#define STEPMOTOR_R_DIR_GPIO_CLK_ENABLE()     __HAL_RCC_GPIOB_CLK_ENABLE()     // 电机旋转方向控制，如果悬空不接默认正转
#define STEPMOTOR_R_DIR_PORT                  GPIOB                            // 对应STEPMOTOR的DIR+（控制器使用共阴接法）
#define STEPMOTOR_R_DIR_PIN                   GPIO_PIN_15                      // 而DIR-直接接开发板的GND

#define STEPMOTOR_R_ENA_GPIO_CLK_ENABLE()     __HAL_RCC_GPIOC_CLK_ENABLE()     // 电机使能控制，如果悬空不接默认使能电机
#define STEPMOTOR_R_ENA_PORT                  GPIOC                            // 对应STEPMOTOR的ENA+（控制器使用共阴接法）
#define STEPMOTOR_R_ENA_PIN                   GPIO_PIN_7                       // 而ENA-直接开发板的GND 


#define STEPMOTOR_DIR_FORWARD(Axis) \
{  Stepmotor[Axis].Dir_Port->BSRR = (uint32_t)Stepmotor[Axis].Dir_Pin ;} //设置电机方向,参数Axis:当前活动轴
#define STEPMOTOR_DIR_REVERSAL(Axis)\
{  Stepmotor[Axis].Dir_Port->BSRR = (uint32_t)Stepmotor[Axis].Dir_Pin <<16;}

#define STEPMOTOR_OUTPUT_ENABLE(Axis)\
{  Stepmotor[Axis].Ena_Port->BSRR = (uint32_t)Stepmotor[Axis].Ena_Pin ;} //电机使能控制 参数Axis:当前活动轴
#define STEPMOTOR_OUTPUT_DISABLE(Axis)\
{  Stepmotor[Axis].Ena_Port->BSRR = (uint32_t)Stepmotor[Axis].Ena_Pin<<16;}
