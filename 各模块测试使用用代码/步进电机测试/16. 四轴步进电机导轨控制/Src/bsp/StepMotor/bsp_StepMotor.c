...
/**
  ...
  */
void STEPMOTOR_AxisMoveRel(__IO uint8_t Axis , __IO int32_t step, __IO uint32_t accel, __IO uint32_t decel, __IO uint32_t speed)
{  
...
void STEPMOTOR_AxisMoveAbs(__IO uint8_t Axis, __IO int32_t targert_step,__IO uint32_t accel, __IO uint32_t decel,__IO uint32_t speed)
{
	__IO int32_t rel_step = 0;
	__IO int8_t dir = -1;                           //回原点的方向控制
...
/** 
  ...
  *			      沿表示捕获到原点,立刻停止.
  */
void STEPMOTOR_AxisHome(__IO uint8_t Axis, __IO int32_t FastSeekSpeed, __IO uint32_t SlowSeekSpeed,__IO uint32_t accel, __IO uint32_t decel)
{
...
/**
  ...
  *             
  */
void STEPMOTOR_DisMoveAbs(__IO uint8_t Axis, __IO uint16_t Target_Dis, __IO uint32_t accel, __IO uint32_t decel, __IO uint32_t speed)
{
  __IO int32_t step; 
...
void HAL_TIM_OC_Callback(uint8_t Axis)
{
  ...
  __IO  uint16_t new_step_delay = 0;
