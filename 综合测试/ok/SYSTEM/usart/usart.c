...
__IO uint32_t g_set_speed  = 100;//* radtor;    //圈/s    //600 * 5.729578;   /* 最大速度 单位为 0.1rad/sec */   //0.1弧度每秒  1rad = 5.729578
...
__IO uint16_t g_step_angle = 100;             /* 设置的步数*/   //对应圈数 8细分下
